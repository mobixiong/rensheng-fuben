...
from app.providers.image.adapter import load_image_prompt
from app.providers.llm.adapter import load_copy_to_story_prompt, load_improve_image_prompt, load_theme_ideas_prompt, load_theme_prompt
