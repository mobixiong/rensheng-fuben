...
from app.media.audio.assets import WORKSPACE_SFX_DIR, list_bgm_options, list_intro_sfx_options
from app.core.paths import WORKSPACE
from app.projects.reference_assets import (
    ReferenceAssetError,
    add_asset,
    create_collection,
    delete_asset,
...
from app.core.schemas import ReferenceCollectionCreateRequest
from app.media.audio.upload import AudioUploadError, save_uploaded_audio
